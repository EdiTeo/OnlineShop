            ...
            <header className="flex border-b border-gray-300 py-3 px-4 sm:px-10 bg-white min-h-[65px] tracking-wide relative z-50">
              <div className="flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full">
                    ...
                    <a href="" className="max-sm:hidden">
                      <img src="/logo_principal.svg" alt="logo" className='w-[134px]' />
                    </a>
                    {/* Logo responsivo */}
                    <a href="" className="hidden max-sm:block"><img src="/logo_responsivo.svg" alt="logo" className='w-8' />
                    </a>
                    <div id="collapseMenu" className={`${isMenuOpen?"block":"hidden"} lg:!block max-lg:w-full max-lg:fixed max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50`}>
                        ...
                        <ul className='lg:flex lg:ml-14 lg:gap-x-5 max-lg:space-y-3 max-lg:fixed max-lg:bg-white max-lg:w-1/2 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:p-6 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50'>
                            ...
                            <a onClick={handleLinkClick} href=""><img src="/logo_principal.svg" alt="logo" className='w-36' />
                            </a>
                            </li>
                    ...
                    <div className='flex gap-4 ml-auto'>
                        ...
                        <button id="toggleOpen" className='lg:hidden cursor-pointer' onClick={toggleMenu}>
